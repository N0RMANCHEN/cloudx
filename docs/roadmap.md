...
Status: in progress. The legacy HTTP importer is reversibly stopped/disabled with its complete rollback boundary retained. The replacement workstation has no legacy port-`18317` tunnel, but three live legacy package processes remain; the signed legacy-health bridge is not installed, and cloud runtime rollback consumers remain retained.
