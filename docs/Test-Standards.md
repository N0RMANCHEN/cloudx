...
- CPA policy tests cover exact upstream-commit and patch-digest binding, deterministic candidate bytes, the process-global two-request maximum, waiting backpressure, control-endpoint exclusion, preservation of local fast-service-tier mapping, two-signal permanent-auth receipt emission, weekly/quota/429/network/timeout/5xx exclusion, digest-bound top-level archive, non-symlink bounded reads, manifest rollback, exact restore, distinct stage/activation confirmations, process-neutral side-by-side staging, baseline-binary preservation, health/policy canaries, real local official-Codex communication before/after activation and after rollback, deferred current-turn-safe scheduling, and automatic launcher/unit rollback.
