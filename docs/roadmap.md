...
Status: source and deterministic candidates ready; signed Cloudx rollout plus durable CPA staging/activation remain separately unapproved.
...
- [ ] Durably stage both CPA candidates with the exact printed `STAGE ... CPA POLICY ...` confirmations while leaving both active process identities unchanged.
